...
- Araç tanımı ekranındaki tüm alanların backend tarafından eksiksiz desteklenmesi:
  - Genel Bilgiler: Ruhsat Sahibi Firma, Cins, Marka, Model, Versiyon, Paket, Araç Grubu, Kasa Tipi, Yakıt, Vites, Model Yılı, Renk, Motor Gücü (hp), Motor Hacmi (cc)
  - Resmi Bilgiler: Şase No, Motor No, Son Tescil Tarihi, Ruhsat Belge No
